...
<body>
	...
	<p>
		...
		<div class="input-group mb-3">
			...
			<input id="mid" name="mid" value="fall" class="form-control" placeholder="Username"
		...
		<div class="input-group mb-3">
			...
			<input id="mname" name="mname" value="홍길동" class="form-control" placeholder="Username"
				aria-label="Username" aria-describedby="basic-addon1">
		</div>
		...
		<div class="input-group mb-3">
			...
			<input id="mpassword" name="mpassword" value="12345" class="form-control" placeholder="Username"
				aria-label="Username" aria-describedby="basic-addon1">
		</div>
	...
	<script>
		function joinAjax(){
			$.ajax({
				url:"join3", //요청경로
				//data:"mid=fall&mname=홍길동", //body 에 실어서 보냄 url에 data를 붙여서 보내도 상관없지만 get방식으로만 되기떄문에 정의
				data:{mid:"fall", mname:"홍길동"},
				method: "post",
				success:function(data){ 
					//받은 내용 을 data에 넣어서 자동적으로 호출 , 콜백함수
